  ...
  describe "as a authenticated user looking to add a friend" do
    it "shows button for authenticated users in the system" do
      VCR.use_cassette("features/user/adds_friends") do
        ...
        user_2 = create(:user, email: 'user_2@example.com', first_name: 'name_2', password: 'password', role: :default, github_token: ENV['GITHUB_TOKEN_M'], uid: 28820023)
        GithubUser.new(name: 'name', url: 'https://github.com/', uid: 28820023)
