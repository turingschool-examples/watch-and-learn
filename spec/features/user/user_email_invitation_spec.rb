...
# Or I should see a message that says "The Github user you selected doesn't have an email address associated with their account."
 ...
 RSpec.describe "as a registered user when I visit /dashboard and click Send Invite" do 
   ...
   it "it shows me a messsage 
   'The Github user you selected doesn't have an email address associated with their account if the user does not have an email addres" do 
