...
describe "invite guest" do
  it "can invite guest using github handle" do
    ...
    tutorial_1 = create(:tutorial, title: "title_1")
      video_1 = create(:video, title: "video_1", position: 1)
      video_2 = create(:video, title: "video_2", position: 2)
      video_3 = create(:video, title: "video_3", position: 3)

    tutorial_2 = create(:tutorial, title: "title_2")
      video_4 = create(:video, title: "video_4", position: 1)
      video_5 = create(:video, title: "video_5", position: 2)
      video_6 = create(:video, title: "video_6", position: 3)
