...
ActiveRecord::Schema.define(version: 2019_10_14_205519) do
  ...
  create_table "friendships", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.bigint "friendship_user_id"
    t.index ["friendship_user_id"], name: "index_friendships_on_friendship_user_id"
    t.index ["user_id", "friendship_user_id"], name: "index_friendships_on_user_id_and_friendship_user_id", unique: true
