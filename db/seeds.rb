...
User.create!(email: 'james@example.com', first_name: 'James', last_name: 'Cape', password: 'password', role: :default)
User.create!(email: 'martin@example.com', first_name: 'Martin', last_name: 'Mercer', password: 'password', role: :default)
User.create!(email: 'mills@example.com', first_name: 'Mills', last_name: 'Provosty', password: 'password', role: :default)
